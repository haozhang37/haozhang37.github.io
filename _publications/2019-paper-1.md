...
excerpt: 'This paper proposed a method to hide the input information into a random phase of Complex-Valued neural networks. In this way, attackers cannot fetch the input information from intermediate-layer features.'
date: 2020-04-30
venue: 'ICLR'
